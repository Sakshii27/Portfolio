...
function nextt(){
    document.getElementById("contentt" + (ii+1)).classList.remove("active");
    ii = ( jj + ii + 1) % jj;
    document.getElementById("contentt" + (ii+1)).classList.add("active");
    indicator( ii+ 1 );
}
...
function nexttt(){
    document.getElementById("contenttt" + (iii+1)).classList.remove("active");
    iii = ( jjj + iii + 1) % jjj;
    document.getElementById("contenttt" + (iii+1)).classList.add("active");
    indicator( iii+ 1 );
}
